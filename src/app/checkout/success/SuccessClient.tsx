...
export type PostOrderPromo = {
  code: string
  discountPercent: number
}

function SuccessInner({ promo }: { promo: PostOrderPromo | null }) {
        ...
        {promo ? (
          <>
            <div className="mt-12 sm:mt-14 text-[20px] sm:text-[26px] leading-snug">
              <p>
                Лови {promo.discountPercent}% знижки на наступне, поки
              </p>
          ...
          <div className="mt-12 sm:mt-14 text-[20px] sm:text-[26px] leading-snug">
            <p>Очікуй повідомлення від нас 🤍</p>
          </div>
        )}
      </div>
    </section>
