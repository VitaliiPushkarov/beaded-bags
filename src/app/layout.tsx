...
function metadataByLocale(locale: Locale): Metadata {
  ...
  const title = isEn
    ...
    : 'GERDAN — Сумки з бісеру, шопери та аксесуари ручної роботи'
  const description = isEn
    ? 'GERDAN online store - modern handmade beaded bags, shoppers and accessories.'
    : 'Інтернет-магазин GERDAN — сучасні сумки з бісеру, шопери та аксесуари ручної роботи. Український бренд із душею.'
  const ogDescription = isEn
    ? 'Modern handmade accessories from GERDAN.'
