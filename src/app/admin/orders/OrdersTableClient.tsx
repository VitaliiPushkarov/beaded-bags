          ...
          return (
            <div key={o.id} className="p-4">
              <div className="flex items-start justify-between gap-3">
                ...
                <select
                  className={`h-8 shrink-0 cursor-pointer rounded-md border px-2 text-xs ${STATUS_STYLES[o.status]}`}
                  value={o.status}
                  onChange={(e) =>
                      ...
                      <div key={idx} className="flex items-start gap-3">
                        ...
                        <div className="min-w-0">
                          <div className="flex items-start gap-2">
                            ...
                            <span className="inline-flex whitespace-nowrap rounded-full border px-2 py-0.5 text-xs">
                              ×{it.qty}
                            </span>
                          </div>
              ...
              <div className="mt-4 flex items-center justify-between text-sm">
                <div>
                  ...
                  <div className="whitespace-nowrap font-medium">{o.totalUAH} ₴</div>
                </div>
          ...
          <TableBody>
            {localOrders.map((o) => (
              <TableRow key={o.id}>
                ...
                <TableCell className="text-right">{o.totalUAH} ₴</TableCell>
                <TableCell>
                  <select
                    className={`h-8 cursor-pointer rounded-md border px-2 text-xs ${STATUS_STYLES[o.status]}`}
                    value={o.status}
                    onChange={(e) =>
                      onStatusChange(o.id, e.target.value as OrderStatus)
                    }
